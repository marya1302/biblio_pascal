...
{29}function Min_ch(X:longint):longint;(*Renvoi le plus petit chiffre d'un nombre donné X*)

{30}function Max_ch (X:longint):longint;(*Renvoi le plus grand chiffre d'un nombre donné X*)

{31}function permutch (A,ch2,pos:longint):longint; {remplace le chiffre de la position "pos" par "ch2"}

{32}function DecCirculaire (a:longint):longint; {faire un decalage circulaire sur un nombre N donn�}
...
{9}procedure lect1d (var T:Tab; var taille:longint); {Lit un tableau � une dimension dont les �l�ments sont des entiers}
...
//--------------(*Extraire un nombre de k chiffres de x … partir de la position pos*)--------------
   begin
...
//--------------(*Donne le miroir d'un nombre x (met le nombre à l'envers)*)--------------
var s,h:longint;
begin
         if (x<>0) then
           begin
...
//------------(*Verifie si deux nombres sont composé de meme chiffres*)-----------------
Var ch:longint; inter:boolean;
Begin
X1:=abs(X1); X2:=abs(X2);
Inter:=true;
...
//------------(*Renvoi le plus petit chiffre d'un nombre donné X*)------------
Var inter:longint;
Begin
Inter:=9 ; X:=abs(X);
repeat
...
//-----------(*Renvoi le plus grand chiffre d'un nombre donné X*)-----------
Var inter:longint;
Begin
Inter:=0 ; X:=abs(X);
while(X>0)do
...
{************************************************}
{faire le decalage circulaire d'un nombre N donn�}
{************************************************}
...
{*****************************************************************}
{Lit un tableau � une dimension dont les �l�ments sont des entiers}
{*****************************************************************}
var i:longint;
begin
